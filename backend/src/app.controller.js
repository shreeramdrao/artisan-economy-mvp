...
var AppController = function () {
    var _classDecorators = [(0, common_1.Controller)(), (0, swagger_1.ApiTags)('health')];
    ...
    (function () {
        ...
        _getHealth_decorators = [(0, common_1.Get)('health'), (0, swagger_1.ApiOperation)({ summary: 'Health check endpoint' })];
